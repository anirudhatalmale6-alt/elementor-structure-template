    ...
    return [container(
        [row([
            col([image(aid, url, extra={
                ...
                width=20, width_tablet=28, width_mobile=52,
                settings={"flex_justify_content": "center",
                          "flex_align_items": "flex-start"}),
            col([nav_menu()], width=58, width_tablet=40, width_mobile=36,
                settings={"flex_justify_content": "center"}),
            col([lang_switcher()], width=16, width_tablet=24, width_mobile=100,
                settings={"flex_justify_content": "center"}),
